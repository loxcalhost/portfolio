export const frontmatter = {
  ...
  description:
    "Complete Hack The Box Fawn writeup for beginners. Learn how to perform Nmap enumeration and exploit FTP misconfiguration using anonymous login.",
  date: "2025-03-07",
};
...
export const metadata = {
  ...
  description:
    "Step-by-step Hack The Box Fawn writeup. Learn how to enumerate services with Nmap, identify FTP misconfiguration, and use anonymous login to retrieve the flag.",
};
